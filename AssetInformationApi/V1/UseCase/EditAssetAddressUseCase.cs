...
{
    public class EditAssetAddressUseCase : IEditAssetAddressUseCase
    {
        private readonly IAssetGateway _assetGateway;
        private readonly ISnsGateway _snsGateway;
        private readonly ISnsFactory _snsFactory;

        public EditAssetAddressUseCase(IAssetGateway assetGateway, ISnsGateway snsGateway, ISnsFactory snsFactory)
        {
